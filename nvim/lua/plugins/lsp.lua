  ...
  -- LSP Configuration
  {
    ...
    config = function()
      ...
      local diagnostic_signs = {
        { name = 'DiagnosticError', text = get_icon('DiagnosticError') },
        { name = 'DiagnosticWarn', text = get_icon('DiagnosticWarn') },
        { name = 'DiagnosticHint', text = get_icon('DiagnosticHint') },
        { name = 'DiagnosticInfo', text = get_icon('DiagnosticInfo') },
      }
          ...
          settings = {
            yaml = {
              schemas = {
                ...
                ['https://raw.githubusercontent.com/kubernetes/kubernetes/master/api/openapi-spec/swagger.json'] = '*k8s*.yml',
              },
              validate = true,
              format = { enable = true },
            },
        ...
        eslint = {
          ...
          on_attach = function(client, bufnr)
            ...
            if package_json ~= '' then
              ...
              if package_content:match('react%-native') then is_react_native = true end
            end
            ...
            if is_react_native then
              ...
              vim.api.nvim_buf_create_user_command(
                ...
                { desc = 'Fix all auto-fixable ESLint errors' }
              )
            end
          end,
        },
