    ...
    opts = {
        ...
        prettier = {
          ...
          prepend_args = function(self, ctx)
            ...
            if is_react_native then
              ...
              if prettier_config ~= '' then return { '--config', prettier_config } end
      ...
      format_on_save = function(bufnr)
        ...
        if filetype == 'python' then
          ...
          if vim.g.python_format == false then return end
    ...
    init = function()
      ...
      vim.api.nvim_create_user_command('FormatToggle', function(args)
        if args.bang then
          ...
          vim.notify(
            'Global autoformatting ' .. (vim.g.disable_autoformat and 'disabled' or 'enabled'),
            vim.log.levels.INFO
          )
        else
          ...
          vim.notify(
            'Buffer autoformatting ' .. (vim.b.disable_autoformat and 'disabled' or 'enabled'),
            vim.log.levels.INFO
          )
        end
      end, { bang = true })
